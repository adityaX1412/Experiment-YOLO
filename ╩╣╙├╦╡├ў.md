...
5. Asymptotic Feature Pyramid Network[reference](https://github.com/gyyang23/AFPN/tree/master)
    ...
    a. ultralytics/cfg/models/v5/yolov5-AFPN-P345.yaml   （试一下这个再试一下yolov8同样的这个，看看效果，0.248）
...
23. ultralytics/cfg/models/v5/yolov5-C3-DCNV2.yaml  （这几个DCN似乎对小目标比较友好）
...
67. ultralytics/cfg/models/v5/yolov5-C3-DWR-DRB.yaml （可以试试）
...
69. ultralytics/cfg/models/v5/yolov5-ASF-P2.yaml （yolov8用这个效果很好）
...
71. ultralytics/cfg/models/v5/yolov5-TransNeXt.yaml （这个小目标应该也可以，可以尝试一下）
...
94. ultralytics/cfg/models/v5/yolov5-MultiSEAMHead.yaml （这个也可以试试）
...
49. ultralytics/cfg/models/v8/yolov8-SPDConv.yaml（这个涨点应该也可以的,0.236）
...
57. ultralytics/cfg/models/v8/yolov8-C2f-DWR.yaml （可以试试）
...
75. ultralytics/cfg/models/v8/yolov8-ASF.yaml (26左右，还行)

    使用[ASF-YOLO](https://github.com/mkang315/ASF-YOLO)中的Attentional Scale Sequence Fusion改进yolov8.

76. ultralytics/cfg/models/v8/yolov8-ASF-P2.yaml （效果很好很好！）
...
78. ultralytics/cfg/models/v8/yolov8-TransNeXt.yaml (这个运行的时候会报错)
...
121. ultralytics/cfg/models/v8/yolov8-C2f-RVB-EMA.yaml （可以试试，0.18）
